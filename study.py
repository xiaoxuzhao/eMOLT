...
my_map.plot(x1,y1, 'yo', markersize=12)
x2,y2=my_map(lon_BD,lat_BD)
my_map.plot(x2,y2, 'yo', markersize=12)
x3,y3=my_map(lon_TS,lat_TS)
my_map.plot(x3,y3, 'yo', markersize=12)
plt.text(x1[0], y1[0],'BN01',fontsize=10,fontweight='bold', ha='left',va='top',color='black')
plt.text(x2[0], y2[0],'BD01',fontsize=10,fontweight='bold', ha='left',va='top',color='black')
plt.text(x3[0], y3[0],'TS02',fontsize=10,fontweight='bold', ha='left',va='top',color='black')
plt.text(55279.5583607422,138227.88966818247 ,'Massachusetts',fontsize=15,fontweight='bold', ha='left',va='top',color='black')
plt.text(5279.5583607422,318227.88966818247 ,'New Hampshire',fontsize=15,fontweight='bold', ha='left',va='top',color='black')
a.set_title('study area',fontsize=20)
my_map.drawparallels(np.arange(30,80,1),labels=[1,0,0,1])
my_map.drawmeridians(np.arange(-180,180,1),labels=[1,1,0,1])
plt.savefig(save_dir+'study_area',dpi=200)
plt.show()
...
temp1=df.icol(temp_colnum)
temp=[]
for i in temp1:
    temp.append((i - 32) / 1.8)
...
plt.xlabel(u'change temperature (°C)',fontsize=10)
plt.title('change catch vs change temperature at eMOLT site '+str(t) )

...
temp1=list(df1.icol(temp_colnum))
...
newdate1=[]
temp2=list(df2.icol(temp_colnum))
...
newdate2=[]
temp3=list(df3.icol(temp_colnum))
...
ax1.plot(ne1,monthly_summary1['catch'],'b-',linewidth=1)
#ax1.set_xlabel('Month',fontsize=12)
#ax1.set_ylabel('weekly catch', color='b')
ax2 = ax1.twinx()
ax2.plot(ne1,monthly_summary1['temp'],'r-',linewidth=1)
...
ax1.plot(ne2,monthly_summary2['catch'],'b-',linewidth=1)
ax1.set_xlabel('Month',fontsize=12)
ax1.set_ylabel('monthly catch', color='b')
ax2 = ax1.twinx()
ax2.plot(ne2,monthly_summary2['temp'],'r-',linewidth=1)
ax2.set_ylabel(u'monthly temperature(℉)', color='r')
ax1.set_xlim(0,13)
ax1.text(1.5,1.0,t2+' total number of hauls'+':'+str(h2),fontsize=12)
###############################
ax1=fig.add_subplot(3,1,3)
ax1.plot(ne3,monthly_summary3['catch'],'b-',linewidth=1)
ax1.set_xlabel('Month',fontsize=12)
#ax1.set_ylabel('weekly catch', color='b')
ax2 = ax1.twinx()
ax2.plot(ne3,monthly_summary3['temp'],'r-',linewidth=1)
#ax2.set_ylabel('weekly temperature', color='r')
ax1.set_xlim(0,13)
